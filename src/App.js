      ...
      <div>
        <div className="container-fluid">
          <div className="row">
            ...
            {/* <h3>Navires</h3> */}
            <Bateau isDragging id={"1"} sens={"H"} longueur={5} color="red" modelbateau="carrier.jpg"/>
            <br></br>
            <Bateau isDragging id={"1"} sens={"H"} longueur={4} color="yellow" modelbateau="cuirasse.png"/>
            <br></br>
            <Bateau isDragging id={"1"} sens={"H"} longueur={3} color="cyan" modelbateau="submarine.png"/>
            <br></br>
            <Bateau isDragging id={"1"} sens={"H"} longueur={3} color="green" modelbateau="croiseur.png"/>
            <br></br>
            <Bateau isDragging id={"1"} sens={"H"} longueur={2} color="purple" modelbateau="torpilleur.png"/>
            <br></br>
            </div>
